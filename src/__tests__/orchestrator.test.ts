...
describe('thin orchestrator', () => {
  ...
  it('renders the harness with mise-managed tool declarations', () => {
    ...
    expect(existsSync(join(dir, '.claude/commands/pr-daemon.md'))).toBe(true)
    ...
    expect(existsSync(join(dir, '.codex/commands/pr-daemon.md'))).toBe(true)
    ...
    expect(existsSync(join(dir, '.opencode/commands/pr-daemon.md'))).toBe(true)
    ...
    expect(readFileSync(join(dir, '.codex/commands/pr-daemon.md'), 'utf8')).toContain('bunx @oisincoveney/dev pr-daemon')
